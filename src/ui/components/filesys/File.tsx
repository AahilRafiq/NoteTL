...
export default function ({ fileName, fileID }: { fileName: string, fileID: number }) {
    ...
    return (
        <Link to={`/editor/${fileID}`} className="w-40 h-15 bg-white dark:bg-gray-900 rounded-md shadow-sm p-4 flex items-center gap-2 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
